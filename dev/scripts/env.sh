...
export TEMPORAL_TLS_MODE="${TEMPORAL_TLS_MODE:-disabled}"
export TEMPORAL_NAMESPACE="${TEMPORAL_NAMESPACE:-default}"
export TEMPORAL_AGENT_NAMESPACE="${TEMPORAL_AGENT_NAMESPACE:-default}"
export TEMPORAL_CONNECTORS_NAMESPACE="${TEMPORAL_CONNECTORS_NAMESPACE:-default}"
export TEMPORAL_RELOCATION_NAMESPACE="${TEMPORAL_RELOCATION_NAMESPACE:-default}"
...
apply_local_overrides() {
  ...
  export TEMPORAL_TLS_MODE="disabled"
  unset TEMPORAL_CERT_PATH TEMPORAL_CERT_KEY_PATH TEMPORAL_TLS_CA_PATH TEMPORAL_TLS_SERVER_NAME
  export TEMPORAL_NAMESPACE="default"
  export TEMPORAL_AGENT_NAMESPACE="default"
  export TEMPORAL_CONNECTORS_NAMESPACE="default"
  export TEMPORAL_RELOCATION_NAMESPACE="default"
